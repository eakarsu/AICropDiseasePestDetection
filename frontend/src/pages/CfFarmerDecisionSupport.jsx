...
/**
 * Gap/CFS Feature Page: Farmer decision support
 * Slug: farmer-decision-support
 * Backend: /api/cf-farmer-decision-support
 */
export default function FarmerDecisionSupportPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-farmer-decision-support', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Farmer decision support</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Recommend treatments based on disease type, severity, crop stage, cost-benefit.</p>
