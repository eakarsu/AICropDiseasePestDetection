...
/**
 * Gap/CFS Feature Page: `community_reports` lacks AI moderation / clustering.
 * Slug: community-reports-lacks-ai-moderation-clustering
 * Backend: /api/gap-community-reports-lacks-ai-moderation-clustering
 */
export default function CommunityReportsLacksAiModerationClusteringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-community-reports-lacks-ai-moderation-clustering', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`community_reports` lacks AI moderation / clustering.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`community_reports` lacks AI moderation / clustering.</p>
