...
/**
 * Gap/CFS Feature Page: No webhooks for sensor/weather pushes.
 * Slug: no-webhooks-for-sensor-weather-pushes
 * Backend: /api/gap-no-webhooks-for-sensor-weather-pushes
 */
export default function NoWebhooksForSensorWeatherPushesPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhooks-for-sensor-weather-pushes', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No webhooks for sensor/weather pushes.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No webhooks for sensor/weather pushes.</p>
