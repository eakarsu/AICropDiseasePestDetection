...
/**
 * Gap/CFS Feature Page: Multi-modal crop health assessment
 * Slug: multi-modal-crop-health-assessment
 * Backend: /api/cf-multi-modal-crop-health-assessment
 */
export default function MultiModalCropHealthAssessmentPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-modal-crop-health-assessment', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Multi-modal crop health assessment</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Combine drone imagery, ground-truth sensors, weather data, and ML to predict disease/pest outbreaks.</p>
