...
/**
 * Gap/CFS Feature Page: Integrated pest management (IPM) automation
 * Slug: integrated-pest-management-ipm-automation
 * Backend: /api/cf-integrated-pest-management-ipm-automation
 */
export default function IntegratedPestManagementIpmAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-integrated-pest-management-ipm-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Integrated pest management (IPM) automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Recommend pesticide-free controls (beneficial insects, crop rotation, timing).</p>
