...
/**
 * Gap/CFS Feature Page: `farm_management` lacks AI yield-forecasting endpoint.
 * Slug: farm-management-lacks-ai-yield-forecasting-endpoint
 * Backend: /api/gap-farm-management-lacks-ai-yield-forecasting-endpoint
 */
export default function FarmManagementLacksAiYieldForecastingEndpointPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-farm-management-lacks-ai-yield-forecasting-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`farm_management` lacks AI yield-forecasting endpoint.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`farm_management` lacks AI yield-forecasting endpoint.</p>
