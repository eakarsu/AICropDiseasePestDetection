...
/**
 * Gap/CFS Feature Page: No mobile / field-capture app surfaces beyond REST API.
 * Slug: no-mobile-field-capture-app-surfaces-beyond-rest-api
 * Backend: /api/gap-no-mobile-field-capture-app-surfaces-beyond-rest-api
 */
export default function NoMobileFieldCaptureAppSurfacesBeyondRestApiPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mobile-field-capture-app-surfaces-beyond-rest-api', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No mobile / field-capture app surfaces beyond REST API.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No mobile / field-capture app surfaces beyond REST API.</p>
