...
/**
 * Gap/CFS Feature Page: No calendar integration (only internal crop calendar).
 * Slug: no-calendar-integration-only-internal-crop-calendar
 * Backend: /api/gap-no-calendar-integration-only-internal-crop-calendar
 */
export default function NoCalendarIntegrationOnlyInternalCropCalendarPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-calendar-integration-only-internal-crop-calendar', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No calendar integration (only internal crop calendar).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No calendar integration (only internal crop calendar).</p>
