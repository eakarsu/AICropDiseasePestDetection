...
/**
 * Gap/CFS Feature Page: No payment/marketplace transaction handling.
 * Slug: no-payment-marketplace-transaction-handling
 * Backend: /api/gap-no-payment-marketplace-transaction-handling
 */
export default function NoPaymentMarketplaceTransactionHandlingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-marketplace-transaction-handling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No payment/marketplace transaction handling.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No payment/marketplace transaction handling.</p>
